...
class Uu134SpiderMiddleware(object):
...
class Uu134DownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class JSPageMiddleware(object):
    def __init__(self):
        ...
        self.browser = webdriver.Firefox(firefox_binary=binary) # , firefox_profile=profile

        # self.browser = webdriver.PhantomJS(executable_path='D:/phantomjs/bin/phantomjs.exe', desired_capabilities=dcap, service_args=service_args)
